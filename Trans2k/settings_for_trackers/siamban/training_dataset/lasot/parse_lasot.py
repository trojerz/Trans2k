...
parser.add_argument('--dir',type=str, default='/storage/datasets/tracking/lasot/sequences', help='your lasot data dir')
...
json.dump(lasot, open('/home/ziga/trackers/siamban/training_dataset/lasot/lasot.json', 'w'), indent=4, sort_keys=True)
