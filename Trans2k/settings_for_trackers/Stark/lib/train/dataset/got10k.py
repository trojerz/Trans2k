...
class Got10k(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        if split is not None:
            ...
            elif split == 'transtrain':
                file_path = os.path.join(ltr_path, 'data_specs', 'got10k_transparent.txt')
            elif split == 'trans100':
                file_path = os.path.join(ltr_path, 'data_specs', 'trans100.txt')
            elif split == 'trans500':
                file_path = os.path.join(ltr_path, 'data_specs', 'trans500.txt')
            elif split == 'trans1000':
                file_path = os.path.join(ltr_path, 'data_specs', 'trans1000.txt')
            else:
    ...
    def get_sequence_info(self, seq_id):
        ...
        #print(f'This is seq path: {seq_path}')
        bbox = self._read_bb_anno(seq_path)
        #print(f'This is bbox: {bbox}')
    ...
    def _get_frame_path(self, seq_path, frame_id):
        if seq_path.split('/')[1] == 'home':
            return os.path.join(seq_path, '{:06}.png'.format(frame_id))    # frames start from 1
        else:
