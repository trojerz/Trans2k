...
class TOTBDataset(BaseDataset):
    ...
    def _get_sequence_list(self):
        sequence_list = ["WineGlass_1"]#['Beaker_1','Beaker_10','Beaker_11','Beaker_12','Beaker_13','Beaker_14','Beaker_15','Beaker_2','Beaker_3','Beaker_4','Beaker_5','Beaker_6','Beaker_7','Beaker_8','Beaker_9',
